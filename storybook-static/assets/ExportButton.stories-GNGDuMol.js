import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{R as b}from"./iframe-lSEetYu3.js";const s=({variant:x="matrix",size:N="default",userTier:p="free",dashboardTitle:E="DASHBOARD",onExportStart:_=()=>console.log("◈ Export protocol initiated"),onExportComplete:T=()=>console.log("◈ Export protocol completed"),className:j=""})=>{const[m,v]=b.useState(!1),[g,f]=b.useState(!1),[h,u]=b.useState(!1),C=[{value:"png",label:"QUANTUM_IMAGE",icon:"◢",format:"PNG_MATRIX",restricted:!1},{value:"pdf",label:"NEURAL_DOCUMENT",icon:"◈",format:"PDF_CORE",restricted:!1},{value:"svg",label:"VECTOR_STREAM",icon:"⬡",format:"SVG_NET",restricted:p==="free"},{value:"csv",label:"DATA_MATRIX",icon:"◣",format:"CSV_GRID",restricted:!1}],S=async t=>{v(!0),f(!1),_(),console.log("◈ MATRIX EXPORT PROTOCOL INITIATED:",t),await new Promise(w=>setTimeout(w,2500)),v(!1),T(),console.log("◈ EXPORT PROTOCOL COMPLETED")},k=`
