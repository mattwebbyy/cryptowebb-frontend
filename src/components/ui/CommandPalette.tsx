...
export const CommandPalette: React.FC<CommandPaletteProps> = ({ isOpen, onClose }) => {
  ...
  const staticCommands: Command[] = [
    ...
    {
      id: 'nav-macro',
      label: 'Go to Macro Metrics',
      description: 'Exchange netflows and reserve deltas',
      icon: <BarChart3 className="w-4 h-4" />,
      action: () => navigate('/macro'),
      category: 'Navigation',
      keywords: ['macro', 'metrics', 'netflow', 'reserves'],
    },
    {
      id: 'nav-labels',
      label: 'Go to Labels Directory',
      description: 'Named addresses — exchanges, routers, protocols',
      icon: <Database className="w-4 h-4" />,
      action: () => navigate('/labels'),
      category: 'Navigation',
      keywords: ['labels', 'entities', 'exchanges', 'directory'],
    },
    {
      id: 'nav-settings',
